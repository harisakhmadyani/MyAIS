package com.sambu.myais.Activity.ui.pulang;
 ...
 * Use the {@link PulangFragment#newInstance} factory method to
...
public class PulangFragment extends Fragment {
     ...
     * @return A new instance of fragment PulangFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PulangFragment newInstance(String param1, String param2) {
        PulangFragment fragment = new PulangFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listViewPulang = view.findViewById(R.id.listViewPulang);
    ...
    private void getData(String tanggalAPI) {
        ...
        if (tanggalAPI.equals("Not Send")) {
            data = dataBaseAccess.Where("vwAbsensiNew", "Terkirim = 0 AND KodeAbsen = 'Absen Pulang' ORDER BY Nama");
        } else {
            data = dataBaseAccess.Where("vwAbsensiNew", "date(Tanggal) = date('" + tanggalAPI + "') AND KodeAbsen = 'Absen Pulang' ORDER BY Nama");
        }

        if (data.getCount() == 0) {
            listViewPulang.setAdapter(null);
        } else {
            ...
            listViewPulang.setAdapter(new AdapterHistory(getActivity().getApplicationContext(),ID, RegNo, NIK, Nama, KodeWilayah, Kehadiran, KodeAbsen, Tanggal, KodeSubPersil, Latitude, Longitude, Foto, Terkirim,SerialDevice,AppVersion, TanggalInd, Keterangan));
            listViewPulang.setVisibility(View.VISIBLE);
        }
    }
}