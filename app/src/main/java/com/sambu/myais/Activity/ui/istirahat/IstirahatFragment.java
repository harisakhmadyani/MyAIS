package com.sambu.myais.Activity.ui.istirahat;
 ...
 * Use the {@link IstirahatFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IstirahatFragment extends Fragment {
    String TanggalAPI;
     ...
     * @return A new instance of fragment IstirahatFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static IstirahatFragment newInstance(String param1, String param2) {
        IstirahatFragment fragment = new IstirahatFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_istirahat, container, false);
        listViewIstirahat = view.findViewById(R.id.listViewIstirahat);
    ...
    private void getData(String tanggalAPI) {
        ...
        if (tanggalAPI.equals("Not Send")) {
            data = dataBaseAccess.Where("vwAbsensiNew", "Terkirim = 0 AND KodeAbsen = 'Absen Istirahat' ORDER BY Nama");
        } else {
            data = dataBaseAccess.Where("vwAbsensiNew", "date(Tanggal) = date('" + tanggalAPI + "') AND KodeAbsen = 'Absen Istirahat' ORDER BY Nama");
        }

        if (data.getCount() == 0) {
            listViewIstirahat.setAdapter(null);
        } else {
            ...
            listViewIstirahat.setAdapter(new AdapterHistory(getActivity().getApplicationContext(),ID, RegNo, NIK, Nama, KodeWilayah, Kehadiran, KodeAbsen, Tanggal, KodeSubPersil, Latitude, Longitude, Foto, Terkirim,SerialDevice,AppVersion, TanggalInd, Keterangan));
            listViewIstirahat.setVisibility(View.VISIBLE);
        }
    }
}